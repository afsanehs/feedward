...
abort "only run seeds in development" unless Rails.env.development?
...
20.times do
  ...
  user = User.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: "#{rand(1000000000)}@example.com", password: fake_password, password_confirmation: fake_password, is_validated: true, confirmed_at: Time.now)
...
fake_password = "0123456789"
site_admin = User.create(first_name: "Site".first_name, last_name: "Admin", email: "site_admin@example.com", password: fake_password, password_confirmation: fake_password, is_site_admin: true, is_validated: true,  confirmed_at: Time.now)
site_admin.update(company: Company.all.first)
puts "Site admin created!"

#One fake company_admin_user created for each company
fake_password = "0123456789"
company_admin_1 = User.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: "company_admin_1@example.com", password: fake_password, password_confirmation: fake_password, is_company_admin: true, is_validated: true,  confirmed_at: Time.now)
...
test_user_1 = User.create(first_name: "Jean", last_name: "Dupont", email: "jean_dupont_1@example.com", password: fake_password, password_confirmation: fake_password, company_id: 1, is_validated: true,  confirmed_at: Time.now)
